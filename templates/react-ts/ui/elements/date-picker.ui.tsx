   ...
   return (
      <div className="w-full">
         ...
         <div className="relative">
            ...
            <input {...props} type="date" id="date" className={`border leading-none border-gray-300 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 w-full ${size}`} />
         </div>
      </div>
   );
}
